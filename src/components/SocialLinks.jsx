...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/muhammadrasul-samaritdinov-95a10a327/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@Billionare_",
    icon: Instagram,
    url: "https://www.instagram.com/Billionare_web",
    color: "#E4405F",
  ...
  },
  {
    name: "YouTube",
    displayName: "Youtube",
    subText: "@Billionare web",
    icon: Youtube,
    url: "https://www.youtube.com/@Billionare_web",
    color: "#FF0000",
  ...
  },
  {
    ...
    subText: "@Billionare web",
    icon: Github,
    url: "https://github.com/Billionare-web",
    color: "#ffffff",
